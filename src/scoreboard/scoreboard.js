// Knockout model
var viewModel = {
  blueColorPrimary: ko.observable("#ffd900"),
  blueColorSecondary: ko.observable("#800080"),
  orangeColorPrimary: ko.observable("#003366"),
  orangeColorSecondary: ko.observable("#cc0033"),
